# Minimally fixed copy of GIFStream_APRD/dataset_process/n3d_video_process.py
# (upstream passes type=bool together with action=store_true, which argparse
# rejects at startup). Lives outside GIFStream_APRD/ so the provenance tree
# is untouched. Only two changes: the argparse line and the pre_colmap import path.
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                "..", "GIFStream_APRD", "dataset_process"))
import os
import subprocess
